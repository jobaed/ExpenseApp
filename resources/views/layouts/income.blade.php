                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="row justify-content-between ">
                            ...
                            <div class="align-items-center col">
                                <a href="{{ url('/income-category') }}"
                                    class="float-end btn m-0 btn-sm bg-gradient-primary"> Income Category</a>
                            </div>
                                        ...
                                        <div class="p-5">
                                            <div class="row">
                                                <div class="col-9 col-lg-8 col-md-8 col-sm-9">
                                                    <div>
                                                        <h2 class="mb-0 text-capitalize font-weight-bold">50,0000 <i
                                        ...
                                        <div class="card px-3 py-3">
                                            ...
                                            <table class="table" id="tableData">
                                                ...
                                                <tbody id="tableList">
                                                    ...
                                                    <td> <span class="incomeMony bg-success">12,0000</span> </td>
                                                    <td>08/08/2023</td>
                                                    <td>View | Delete</td>
                                                </tbody>
                                            </table>
